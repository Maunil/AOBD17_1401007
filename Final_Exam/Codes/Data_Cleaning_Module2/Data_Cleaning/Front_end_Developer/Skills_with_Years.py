...
unique_file('Software Developer - Backend.txt','Software Engineer-backend_skills_with_years.txt','Software Developer - Backend_Years.txt','Software_Developer-Backend_Skills.txt')
